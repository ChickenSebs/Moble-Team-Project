...
namespace calendar4
{
    public partial class mainForm : Form
    {
        ...
        private void tool_font_Click(object sender, EventArgs e)
        {
        ...
        {
            UiThemeService.ApplyFont(parent, font);
        }
        ...
        private void tool_image_Click(object sender, EventArgs e)
        {
        ...
        {
            using (var form = new DdaySettingForm(loggedInUserId))
            {
                if (form.ShowDialog(this) == DialogResult.OK)
                {
                    DateTime targetDate = form.SelectedDate;
